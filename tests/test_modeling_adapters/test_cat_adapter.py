"""
Unit tests for CATModelAdapter.
...
class TestCATModelAdapter:
    ...
    def test_adapter_fit_sets_fitted(self, synthetic_classification_data):
        ...
        with patch("energizados.modeling.supervised_models.CATModel") as MockCAT:
            mock_instance = MagicMock()
            mock_instance.train.return_value = mock_pipeline
            MockCAT.return_value = mock_instance

            adapter = CATModelAdapter(cols_for_model=cols)
    ...
    def test_adapter_with_config(self, synthetic_classification_data):
        ...
        adapter = CATModelAdapter(cols_for_model=cols, config=config)
