  ...
  test:
    ...
    steps:
      ...
      - name: Validate configs
        run: |
          poetry run energizados validate --config config/etls.yaml
          poetry run energizados validate --config config/training.yaml
...
- `docs/INITIAL_SETUP_PYPI.md` — Complete first-time PyPI setup guide
...
- **`CONTRIBUTOR_GUIDE.md`** — Setup, execution, and extension for contributors
- **`USER_GUIDE.md`** — End-user documentation
- **`AGENTS.md`** — Rules for AI agents
- **`docs/INITIAL_SETUP_PYPI.md`** — First-time PyPI setup for maintainers
